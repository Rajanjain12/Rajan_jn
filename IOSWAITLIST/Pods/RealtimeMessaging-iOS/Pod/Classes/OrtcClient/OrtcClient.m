...
- (void)opReceive:(NSString*) message {
    ...
    if (json)
    {
        ...
        if (aChannel && aMessage) {
            ...
            //NSTextCheckingResult* multiMatch = [msgRegex firstMatchInString:aMessage options:0 range:NSMakeRange(0, [aMessage length])]; // Mayur
            NSTextCheckingResult* multiMatch ;
