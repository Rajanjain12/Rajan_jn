...
export class DashboardComponent implements OnInit {
	...
	loadFactory() {
		...
		this.client.onConnected = (client) => {
			...
			client.subscribe("RSNT_GUEST_DEV_1", true, (client, channel, message) => { //channel to be replaced
